angular.module('futurism')
    .factory('websites', function($, $rootScope, $routeParams, memory, facebook, jiggmin, delphinoid, guestville, _) {
        'use strict';
        ...
        var self = {
            ...
            getAllowedSites: function() {
                ...
                if(self.forceSite) {
                    ...
                    allowed = [facebook, jiggmin, delphinoid, guestville];
                }
            ...
            getSitesToPoll: function() {
                ...
                if(siteId) {
                    ...
                    allowed = [facebook, jiggmin, delphinoid];
                }
                return allowed;
            },
